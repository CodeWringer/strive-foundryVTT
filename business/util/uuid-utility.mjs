 ...
 * @type {String}
 */
const properFormat = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx';
 ...
 */
export function createUUID(useProperFormat = false) {
    const format = useProperFormat ? properFormat : simpleFormat;
