...
export default class AssetHeaderViewModel extends BaseItemHeaderViewModel {
  /** @override */
  static get TEMPLATE() { return TEMPLATES.application.item.asset.header; }

  /** @override */
  get clazz() { return AssetHeaderViewModel; }
  ...
  constructor(args = {}) {
    ...
    this.vmQuantity = new InputSplitNumberSpinnerViewModel({
      ...
      toolTip: new ViewModelToolTipDefinition({
        localized: StringUtil.getLoca("system.item.asset.quantity"),
      }),
      current: {
        value: this.document.quantity.current,
        min: 0,
