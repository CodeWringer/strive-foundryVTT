...
export default class ProjectHeaderViewModel extends BaseItemHeaderViewModel {
  /** @override */
  static get TEMPLATE() { return TEMPLATES.application.item.project.header; }

  /** @override */
  get clazz() { return ProjectHeaderViewModel; }
  ...
  constructor(args = {}) {
    ...
    this.vmProgress = new InputSplitNumberSpinnerViewModel({
      id: "vmProgress",
      parent: this,
