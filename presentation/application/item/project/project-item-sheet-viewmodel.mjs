...
import ProjectContentViewModel from "./project-content-viewmodel.mjs";
import ProjectHeaderViewModel from "./project-header-viewmodel.mjs";

export default class ProjectItemSheetViewModel extends BaseItemSheetViewModel {
  /** @override */
  get clazz() { return ProjectItemSheetViewModel; }
  ...
  constructor(args = {}) {
    super({
      ...args,
      headerViewModel: new ProjectHeaderViewModel({
        id: "vmHeader",
        isEditable: args.isEditable,
        document: args.document,
        sheet: args.sheet,
      }),
      contentViewModel: new ProjectContentViewModel({
        id: "vmContent",
        isEditable: args.isEditable,
        document: args.document,
        sheet: args.sheet,
