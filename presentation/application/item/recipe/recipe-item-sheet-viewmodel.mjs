...
import RecipeContentViewModel from "./recipe-content-viewmodel.mjs";
import RecipeHeaderViewModel from "./recipe-header-viewmodel.mjs";

export default class RecipeItemSheetViewModel extends BaseItemSheetViewModel {
  /** @override */
  get clazz() { return RecipeItemSheetViewModel; }
