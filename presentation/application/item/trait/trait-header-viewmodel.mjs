...
export default class TraitHeaderViewModel extends BaseItemHeaderViewModel {
  /** @override */
  static get TEMPLATE() { return TEMPLATES.application.item.trait.header; }

  /** @override */
  get clazz() { return TraitHeaderViewModel; }
