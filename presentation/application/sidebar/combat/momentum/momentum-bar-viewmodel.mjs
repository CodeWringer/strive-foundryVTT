...
export default class MomentumBarViewModel extends ViewModel {
  ...
  constructor(args = {}) {
    ...
    const localizedReminder = StringUtil.format2(game.i18n.localize("system.combat.momentum.reminder.reminder"), {
      ...
      row1: `${game.i18n.localize("system.combat.momentum.reminder.losingMomentum.1")}${game.i18n.localize("system.combat.momentum.reminder.gainingMomentum.1")}`,
      row2: `${game.i18n.localize("system.combat.momentum.reminder.losingMomentum.2")}${game.i18n.localize("system.combat.momentum.reminder.gainingMomentum.2")}`,
      row3: `${game.i18n.localize("system.combat.momentum.reminder.losingMomentum.3")}${game.i18n.localize("system.combat.momentum.reminder.gainingMomentum.3")}`,
      row4: `${game.i18n.localize("system.combat.momentum.reminder.losingMomentum.4")}${game.i18n.localize("system.combat.momentum.reminder.gainingMomentum.4")}`,
      row5: `${game.i18n.localize("system.combat.momentum.reminder.losingMomentum.5")}${game.i18n.localize("system.combat.momentum.reminder.gainingMomentum.5")}`,
    });
