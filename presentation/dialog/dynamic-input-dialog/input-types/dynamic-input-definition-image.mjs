...
/**
 * Displays and allows picking an image. 
 * 
 * For use in a `DynamicInputDialog`. 
 * 
 * @property {DYNAMIC_INPUT_TYPES} type Returns `DYNAMIC_INPUT_TYPES.IMAGE`. 
 ...
 */
export default class DynamicInputDefinitionImage extends DynamicInputDefinition {
  /**
   * @param {Object} args 
  ...
  constructor(args = {}) {
    super({
      ...args,
      type: DYNAMIC_INPUT_TYPES.IMAGE,
    });
  }
}