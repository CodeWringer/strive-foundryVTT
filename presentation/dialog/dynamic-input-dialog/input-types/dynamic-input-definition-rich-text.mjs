...
/**
 * Allows a user to enter multiple lines of richly formatted text. 
 * 
 * For use in a `DynamicInputDialog`. 
 * 
 * @property {DYNAMIC_INPUT_TYPES} type Returns `DYNAMIC_INPUT_TYPES.RICH_TEXT`. 
 ...
 */
export default class DynamicInputDefinitionRichText extends DynamicInputDefinition {
  /**
   * @param {Object} args 
  ...
  constructor(args = {}) {
    super({
      ...args,
      type: DYNAMIC_INPUT_TYPES.RICH_TEXT,
    });
  }
}