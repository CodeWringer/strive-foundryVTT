 ...
 * 
 * @property {DYNAMIC_INPUT_TYPES} type Returns `DYNAMIC_INPUT_TYPES.TEXTFIELD`. 
 ...
 */
export default class DynamicInputDefinitionTextfield extends DynamicInputDefinition {
  /**
   * @param {Object} args 
