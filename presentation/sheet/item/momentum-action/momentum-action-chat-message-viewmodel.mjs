...
export default class MomentumActionChatMessageViewModel extends ViewModel {
  /** @override */
  static get TEMPLATE() { return game.strive.const.TEMPLATES.MOMENTUM_ACTION_CHAT_MESSAGE; }
