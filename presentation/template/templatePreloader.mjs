export const TEMPLATES = {
  // --- Components
  // Inputs
  COMPONENT_INPUT_TEXTFIELD: "systems/ambersteel/module/component/input-textfield/input-textfield.hbs",
  COMPONENT_INPUT_DROPDOWN: "systems/ambersteel/module/component/input-dropdown/input-dropdown.hbs",
  COMPONENT_INPUT_NUMBER_SPINNER: "systems/ambersteel/module/component/input-number-spinner/input-number-spinner.hbs",
  COMPONENT_INPUT_TEXTAREA: "systems/ambersteel/module/component/input-textarea/input-textarea.hbs",
  COMPONENT_INPUT_RADIO_BUTTON_GROUP: "systems/ambersteel/module/component/input-radio-button-group/input-radio-button-group.hbs",
  COMPONENT_INPUT_LABEL: "systems/ambersteel/module/component/label/label.hbs",
  COMPONENT_INPUT_ITEM_GRID_VIEW: "systems/ambersteel/module/component/item-grid/item-grid-view.hbs",
  COMPONENT_INPUT_IMAGE: "systems/ambersteel/module/component/input-image/input-image.hbs",
  COMPONENT_INPUT_RICH_TEXT: "systems/ambersteel/module/component/input-rich-text/input-rich-text.hbs",
  // Buttons
  COMPONENT_BUTTON: "systems/ambersteel/module/component/button/button.hbs",
  COMPONENT_BUTTON_ADD: "systems/ambersteel/module/component/button-add/button-add.hbs",
  COMPONENT_BUTTON_DELETE: "systems/ambersteel/module/component/button-delete/button-delete.hbs",
  COMPONENT_BUTTON_OPEN_SHEET: "systems/ambersteel/module/component/button-open-sheet/button-open-sheet.hbs",
  COMPONENT_BUTTON_ROLL: "systems/ambersteel/module/component/button-roll/button-roll.hbs",
  COMPONENT_BUTTON_SEND_TO_CHAT: "systems/ambersteel/module/component/button-send-to-chat/button-send-to-chat.hbs",
  COMPONENT_BUTTON_TOGGLE_VISIBILITY: "systems/ambersteel/module/component/button-toggle-visibility/button-toggle-visibility.hbs",
  COMPONENT_BUTTON_TAKE_ITEM: "systems/ambersteel/module/component/button-take-item/button-take-item.hbs",
  COMPONENT_BUTTON_TOGGLE: "systems/ambersteel/module/component/button-toggle/button-toggle.hbs",
  COMPONENT_BUTTON_CONTEXT_MENU: "systems/ambersteel/module/component/button-context-menu/button-context-menu.hbs",
  // Composite
  COMPONENT_SORTABLE_LIST: "systems/ambersteel/module/component/sortable-list/sortable-list.hbs",
  // GM
  COMPONENT_GM_NOTES: "systems/ambersteel/presentation/template/gm-notes.hbs",
  // Dice
