...
export default class ActorBeliefsFateViewModel extends SheetViewModel {
  ...
  constructor(args = {}) {
    ...
    this.beliefsViewModel = new ActorBeliefsViewModel({ ...args, id: "beliefsViewModel", parent: thiz });
    this.children.push(this.beliefsViewModel);

    this.fateViewModel = new ActorFateViewModel({ ...args, id: "fateViewModel", parent: thiz });
    this.children.push(this.fateViewModel);
  }
}
